...
class CommunitiesControllerTest < ActionController::TestCase
  ...
  test "should create community" do
    assert_difference('Community.count') do
      post :create, community: { description: @community.description, main_image: @community.main_image, name: @community.name }
    end
  ...
  test "should update community" do
    patch :update, id: @community, community: { description: @community.description, main_image: @community.main_image, name: @community.name }
    assert_redirected_to community_path(assigns(:community))
  end
